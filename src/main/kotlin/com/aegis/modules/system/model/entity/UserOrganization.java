...
/**
*  t_sys_user_organization(用户机构表) 对应数据表, 表结构改变这里需要同步修改（表结构不变不允许修改）
*
...
*  @since 1.0
*/
@TableName("t_sys_user_organization")
@ApiModel(value="UserOrganization对象", description="用户机构表")
public class UserOrganization implements Serializable{

  @ApiModelProperty(value = "雪花主键")
  @TableId(value = "user_organization_id", type = IdType.ASSIGN_ID)
